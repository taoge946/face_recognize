...
predictor = dlib.shape_predictor('data/data_dlib/shape_predictor_68_face_landmarks.dat')#利用训练好的模型检测68个关键点

# Dlib Resnet 人脸识别模型，提取 128D 的特征矢量 / Use Dlib resnet50 model to get 128D face descriptor
face_reco_model = dlib.face_recognition_model_v1("data/data_dlib/dlib_face_recognition_resnet_model_v1.dat")#通过关键点检测结果得到128维向量表示
